...
namespace DNC_CSharp_Demo.UserControls
{
    ...
    public partial class RemoteError : UserControl
    {
        ...
        public RemoteError(MainForm parentForm)
        {
            ...
            this.CreateErrorEntryButton.Enabled = true;

            //Thread.Sleep(1000);

            //CreateErrorEntryButton.PerformClick();
        }
        #endregion
        ...
        public bool Init()
        {
            try
            {
                ...
                this.initOkay = true;
                this.CreateErrorEntryButton.PerformClick();
        ...
        {
            List<string> validErrorClass = Enum.GetNames(typeof(HeidenhainDNCLib.DNC_ERROR_CLASS))
                                              .Where(name => name == "DNC_EC_INFO" || name == "DNC_EC_ERROR")
                                              .ToList();
      ...
      */
      ...
      GC.WaitForPendingFinalizers();
        ...
        /// <param name="sender">The parameter is not used.</param>
        /// <param name="e">The parameter is not used.</param>
        public void CreateErrorEntryButton_Click(object sender, EventArgs e)
        {
            Console.WriteLine("click");
            string ddTXT= DataAccess.ErrorOrInfo;
            ...
            foreach (string line in lines)
            {
                ...
                if (match.Success)
                {
                    ...
                    int primaryKeyValue = int.Parse(currentSecondList[0]);
                    string toolName = (currentSecondList[1]);
                    ...
                    try
                    {
                        int errorNumber = Convert.ToInt32(primaryKeyValue);

                        // Only create error entry if error number doesn't exist.
                        if (this.GetErrorByNumber(errorNumber) == null)
                        {
                            HeidenhainDNCLib.DNC_ERROR_CLASS errorClass = (HeidenhainDNCLib.DNC_ERROR_CLASS)Enum.Parse(typeof(HeidenhainDNCLib.DNC_ERROR_CLASS), ddTXT);
                            ...
                            tmpEntry = this.remoteError.CreateEntry(primaryKeyValue, errorClass, "T " + primaryKeyValue + " " + toolName + " " + "Datenuebertragung Fehlgeschlagen");
            ...
            //    if (this.GetErrorByNumber(errorNumber) == null)
            //    {
            //        HeidenhainDNCLib.DNC_ERROR_CLASS errorClass = (HeidenhainDNCLib.DNC_ERROR_CLASS)Enum.Parse(typeof(HeidenhainDNCLib.DNC_ERROR_CLASS), "DNC_EC_ERROR");
            //        string errorString = ErrorMessageTextBox.Text;
            //        bool withRemoteAck = RemoveAckCheckBox.Checked;
