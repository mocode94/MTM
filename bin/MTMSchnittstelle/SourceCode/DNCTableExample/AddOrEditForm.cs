...
namespace DNC_CSharp_Demo
{
    ...
    public partial class AddOrEditForm : Form
    {
        ...
        public AddOrEditForm(JobType job, List<string> currentSecondList, HeidenhainDNCLib.JHDataAccess dataAccess)
        {
            string primaryKeyValue=currentSecondList[0];
            currentSecondListinAddOrEdirForm = currentSecondList;
            this.InitializeComponent();
            this.components = new Container();
            Debug.WriteLine("AddOrEditForm runs");
            this.job = job;
        ...
        private void FrmAddOrEdit_Load(object sender, EventArgs e)
        {
            switch (this.job)
            {
                case JobType.addRow:
                    ...
                    ChooseNewItemComboBox.Text = primaryKeyValue;
                    SelectItemButton_Click(this, EventArgs.Empty);
        ...
        private void SelectItemButton_Click(object sender, EventArgs e)
        {
            ...
            switch (this.job)
            {
                case JobType.addIndex:
                    ...
                    break;
                case JobType.addRow:
                    Debug.WriteLine($"Here is ChosseNewItemCombobox{ChooseNewItemComboBox.Text}");
                    this.primaryKeyValue = ChooseNewItemComboBox.Text;
                    break;
            }
        ...
        private void LockRowOnControl()
        {
            ...
            */
            ...
            Debug.WriteLine("LockRowOnControl Ende");
        }
        ...
        private bool WriteTableData()
        {
            ...
            try
            {
                ...
                //toolName = currentSecondListinAddOrEdirForm[1];   // Second value (index 1)
                //toolLong = currentSecondListinAddOrEdirForm[2];    // Third value (index 2)
                //toolRadius = currentSecondListinAddOrEdirForm[3];  // Fourth value (index 3)
                ...
                //        string secondList = match.Groups[1].Value;

                //        // Split the second list by commas to get individual values
                //        string[] secondListValues = secondList.Split(',');

                //        if (secondListValues.Length >= 4)
                //        {
                //            // Get the values from the second list
                //            toolName = secondListValues[1];    // Second value (index 1)
                //            toolLong = secondListValues[2];    // Third value (index 2)
                //            toolRadius = secondListValues[3];  // Fourth value (index 3)

                //            // Output the results
                //            Console.WriteLine($"Tool Name: {toolName}");
                //            Console.WriteLine($"Tool Long: {toolLong}");
                //            Console.WriteLine($"Tool Radius: {toolRadius}");
                //        }
                //        else
                //        {
                //            Console.WriteLine("The second list does not contain enough values.");
                //        }
                //    }
                //    else
                //    {
                //        Console.WriteLine("The expected list format was not found in the file.");
                //    }
                //}
                //catch (Exception ex)
                //{
                ...
                foreach (UserControls.TableDataUserControl tableData in TableDataFlowLayoutPanel.Controls)
                {
                    ...
                    if (tableData.ColumnName == "NAME")
                    {
                        tableData.VarValue = toolName;
                    }
                    if (tableData.ColumnName == "L")
                    {
                        tableData.VarValue = toolL;
                    }
                    if (tableData.ColumnName == "R")
                    {
                        tableData.VarValue = toolR;
                    }

                    if (tableData.ColumnName == "TYP")
                    {
                        tableData.VarValue = toolTyp;
                    }
                    if (tableData.ColumnName == "R2")
                    {
                        tableData.VarValue = toolR2;
                    }
                    if (tableData.ColumnName == "T-ANGLE")
                    {
                        tableData.VarValue = toolTangle;
                    }
                    if (tableData.ColumnName == "ANGLE")
                    {
                        tableData.VarValue = toolAngle;
                    }
                    if (tableData.ColumnName == "CUT")
                    {
                        tableData.VarValue = toolCut;
                    }
                    if (tableData.ColumnName == "LCUTS")
                    {
                        tableData.VarValue = toolLcuts;
                    }
                    if (tableData.ColumnName == "PITCH")
                    {
                        tableData.VarValue = toolPitch;
                    }
                    if (tableData.ColumnName == "DOC")
                    {
                        tableData.VarValue = toolDoc;
                    }
                    if (tableData.ColumnName == "NMAX")
                    {
                        tableData.VarValue = toolNmax;
                    }
                    if (tableData.ColumnName == "TIME1")
                    {
                        tableData.VarValue = toolTime1;
                    }
                    if (tableData.ColumnName == "TIME2")
                    {
                        tableData.VarValue = toolTime2;
                    }
                    if (tableData.ColumnName == "CUR_TIME")
                    {
                        tableData.VarValue = toolCurTime;
                    }
                    if (tableData.ColumnName == "L-OFFS")
                    {
                        tableData.VarValue = toolLoffs;
                    }
                    if (tableData.ColumnName == "R-OFFS")
                    {
                        tableData.VarValue = toolRoffs;
                    }
                    if (tableData.ColumnName == "LTOL")
                    {
                        tableData.VarValue = toolLtol;
                    }
                    if (tableData.ColumnName == "RTOL")
                    {
                        tableData.VarValue = toolRtol;
                    }
                    if (tableData.ColumnName == "LBREAK")
                    {
                        tableData.VarValue = toolLbreak;
                    }
                    if (tableData.ColumnName == "RBREAK")
                    {
                        tableData.VarValue = toolRbreak;
                    }
                    if (tableData.ColumnName == "DIRECT")
                    {
                        tableData.VarValue = toolDirect;
                    }
                    if (tableData.ColumnName == "P1")
                    {
                        tableData.VarValue = toolP1;
                    }
                    if (tableData.ColumnName == "P8")
                    {
                        tableData.VarValue = toolP8;
                    }
                    if (tableData.ColumnName == "P2")
                    {
                        tableData.VarValue = toolP2;
                    }
                    if (tableData.ColumnName == "KINEMATIC")
                    {
                        tableData.VarValue = toolKinematic;
                    }
                    if (tableData.ColumnName == "PLC")
                    {
                        tableData.VarValue = toolPLC;
                    }
                ...
                this.UnlockRowOnControl();
                Debug.WriteLine("WriteTableData EDNE");
                return true;
            }
            catch (COMException cex)
            {
            ...
            finally
            {
                ...
                Debug.WriteLine("WriteTableData EDNE2");
